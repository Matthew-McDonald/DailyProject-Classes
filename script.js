...
class Factory {
  ...
  static massBuild(quantity, color, trim, model, options) {
    console.log(
      "Building " +
        quantity +
        " " +
  ...
  static customerBuild(quantity, color, trim, model, options) {
    console.log(
      "Building " +
        quantity +
        " " +
...
class Truck extends Factory {
  constructor(model, color, enginesize, hitch, bed, navigation) {
    super(model, color, enginesize, navigation);
    this.hitch = hitch;
    this.bed = bed;
...
console.log(Factory.massBuild(35000, "Red", "Touring", "Mazda3"));
...
console.log(
  Factory.customerBuild(1, "yellow", "Touring", "Mazda3", [
    " Weather Package",
    " Satellite Radio",
    " Rear Spoiler"
  ])
...
// Write your code below:
// model, trim, transmission, color, seatstrim, audio, wheelstrim
...
console.log(Factory.massBuild(15000, "Red", "Grand Touring", "Miata-RF"));
...
console.log(
  Factory.customerBuild(1, "Black", "Grand Touring", "Miata-RF", [
    " Hid Headlights",
    " Sports Suspension",
...
console.log(Factory.massBuild(35000, "Blue", "Sport", "Trail Blazer"));
...
console.log(
  Factory.customerBuild(1, "Red", "Sport", "Trail Blazer", [
    " Seat Warmers",
    " Tinted Windows",
    " Fog Lamps"
  ])
